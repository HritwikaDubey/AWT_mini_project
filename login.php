      ...
      <div class="panels-container">
        <div class="panel left-panel">
          <div class="content">
            <h1>New here ?</h1>
            <p>
              Welcome to <b>Encircle MITWPU !</b> Get started with your account.
            </p>
        ...
        <div class="panel right-panel">
          <div class="content">
            <h1>One of us ?</h1>
            <p>
              Welcome back! Click here to Log in to your account using email and password.
            </p>
            <button class="btn transparent" id="sign-in-btn">
              Sign in
            </button>
          </div>
          <img src="Images/signup.svg" class="image1" alt="" />
        </div>
      </div>
    </div>
